        ...
        <li class="flex flex-row p-1 justify-between bg-slate-100 rounded-3xl mb-3">
            <div class="my-2 mx-4">
                <div class="flex flex-row">
                    <img class="w-10 mr-4" src="/assets/airplane-logo.svg" alt="" />
                    <h3 class="text-base">Timefast Indonesia</h3>
                </div>
            ...
            <div class="my-2 mx-4">
                <div class="flex flex-row items-center">
                    ...
                    <div class="text-center">
                        <h5>14.40</h5>
                        <p class="text-sm text-gray-500">KNO</p>
                    </div>
                </div>
            </div>
            <div class="my-2 mx-4">
                <div class="text-right">
                    <p class="flex items-center">
                        ...
                        <span class="text-base text-orange-600">1.940.222</span>
